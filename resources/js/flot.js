...
$(function() {
		...
		var dataset = [
			...
			{ label: "Male mean", data: males["mean"], lines: { show: true }, color: "rgb(23, 146, 214)" },
			{ id: "m15%", data: males["15%"], lines: { show: true, lineWidth: 0, fill: false }, color: "rgb(23, 146, 214)" },
			{ id: "m25%", data: males["25%"], lines: { show: true, lineWidth: 0, fill: 0.2 }, color: "rgb(23, 146, 214)", fillBetween: "m15%" },
			{ id: "m50%", data: males["50%"], lines: { show: true, lineWidth: 0.5, fill: 0.4, shadowSize: 0 }, color: "rgb(23, 146, 214)", fillBetween: "m25%" },
			{ id: "m75%", data: males["75%"], lines: { show: true, lineWidth: 0, fill: 0.4 }, color: "rgb(23, 146, 214)", fillBetween: "m50%" },
			{ id: "m85%", data: males["85%"], lines: { show: true, lineWidth: 0, fill: 0.2 }, color: "rgb(23, 146, 214", fillBetween: "m75%" }
		];
	...
	$(function() {
		...
		$("#example-1").click(function() {
			...
			$.plot(placeholder, data, {
				...
				colors: ['#1792d6', '#172f71', '#45aaf2', '#ecb403', '#e86a91'],
		...
		$("#example-4").click(function() {
			...
			$.plot(placeholder, data, {
				...
				colors: ['#1792d6', '#172f71', '#45aaf2', '#ecb403', '#64E572'],
				legend: {
					show: false
				}
			});
